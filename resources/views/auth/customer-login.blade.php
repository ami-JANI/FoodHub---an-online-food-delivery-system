...
@section('content')
    ...
    <p class="text-sm text-gray-500 mb-5">Order food from your favorite restaurants.</p>
    ...
    <p class="text-sm text-gray-500 mt-4 text-center">
        New to FoodHub? <a href="{{ route('register') }}" class="text-pink-600 hover:underline">Create an account</a>
    </p>
@endsection
