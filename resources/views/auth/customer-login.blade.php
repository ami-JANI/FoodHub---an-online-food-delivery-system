...
@section('title', 'Sign in - FoodHub')

@section('content')
    <h1 class="text-xl font-bold mb-1">Sign in</h1>
    <p class="text-sm text-gray-500 dark:text-gray-400 mb-5">Order food from your favorite restaurants.</p>
    ...
    <p class="text-sm text-gray-500 dark:text-gray-400 mt-4 text-center">
        New to FoodHub? <a href="{{ route('register') }}" class="text-rose-800 dark:text-rose-400 hover:underline">Create an account</a>
    </p>
@endsection
