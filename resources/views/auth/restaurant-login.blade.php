...
@section('content')
    ...
    <p class="text-sm text-gray-500 mb-5">Manage your restaurant on FoodHub.</p>
    ...
    <p class="text-sm text-gray-500 mt-4 text-center">
        New restaurant? <a href="{{ route('restaurant.register') }}" class="text-pink-600 hover:underline">Join as a partner</a>
    </p>
@endsection
